...
def html2text (data, use_ansi = 0, is_latin1 = 1):
  ...
  if is_latin1:
    ...
    data = re.sub ("&uuml;", "ü", data)
    data = re.sub ("&acirc;", "â", data)
    data = re.sub ("&deg;", "°", data)
    data = re.sub ("&agrave;", "à", data)
    data = re.sub ("&amp;", "&", data)
    data = re.sub ("&ugrave;", "ù", data)
    data = re.sub ("&ucirc;", "û", data)
    data = re.sub ("&agrave", "à", data)
    data = re.sub ("&quot;", "\"", data)
    data = re.sub ("&icirc;", "î", data)
    data = re.sub ("&ecirc;", "ê", data)
    data = re.sub ("&aring;", "å", data)
    data = re.sub ("&sect;", "§", data)
    data = re.sub ("&ocirc;", "ô", data)
